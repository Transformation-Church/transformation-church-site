  ...
  return (
    ...
    >
      <span className="relative block aspect-video overflow-hidden bg-ink/10">
        ...
        {sermon.youtubeId && (
          <span className="absolute bottom-4 left-4 flex h-11 w-11 items-center justify-center rounded-full bg-paper/90 text-ink backdrop-blur transition-colors duration-500 group-hover:bg-accent group-hover:text-paper">
