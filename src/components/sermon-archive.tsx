    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        ...
        <svg
          viewBox="0 0 12 8"
          aria-hidden
          className="pointer-events-none absolute right-1 top-1/2 h-2 w-3 -translate-y-1/2 text-ink/45"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.5"
        >
  ...
  return (
    <>
      ...
      <div className="grid gap-x-10 gap-y-8 border-b border-rule pb-10 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="sermon-search" className="label text-ink/45">
            Search
          </label>
          <input
            id="sermon-search"
            ...
            className="w-full border-b border-rule-strong bg-transparent py-2.5 font-display text-lg text-ink placeholder:text-ink/30 focus:border-ink focus:outline-none"
          />
        </div>
      ...
      <div className="flex items-center justify-between gap-6 py-6">
        <p className="label text-ink/45" role="status" aria-live="polite">
        ...
        {active && (
          <button
            ...
            className="label link-underline text-ink/60 hover:text-ink"
          >
            Clear filters
          </button>
        )}
      ...
      {/* results */}
      {results.length === 0 ? (
        <p className="border-t border-rule py-20 text-center text-lg text-ink/55">
